...
RSpec.describe CreateRubyGem::Detection::BundlerVersion do
  ...
  it 'raises on garbage output' do
    ...
    expect { detector.detect! }.to raise_error(
      CreateRubyGem::UnsupportedBundlerVersionError, /Cannot parse bundler version/
    )
  end
  ...
  it 'raises when bundle executable is not found' do
    ...
    expect { detector.detect! }.to raise_error(
      CreateRubyGem::UnsupportedBundlerVersionError, /Bundler executable not found/
    )
  end
end
